document.write(`
    <div class="item" onclick="location.href='./movies/dynamic.html'; alldata(this)" >
      ...
      and a few unexpected turns. Proving that #95 isn't through yet will test the heart of a champion on Piston Cup
      Racing's biggest stage! —Pixar</a>
      <a class="invisible trailer">https://www.youtube.com/embed/2LeOH9AGJQM</a>
    </div>
    ...
    <div class="item" onclick="location.href='./movies/dynamic.html'; alldata(this)">
      ...
      super
      strength to the power to heal-every child except one, Mirabel. But when she discovers that the magic
      surrounding
      the Encanto is in danger, Mirabel decides that she, the only ordinary Madrigal, might just be her exceptional
      family's last hope. —Walt Disney Animation Studios</a>
      <a class="invisible trailer">https://www.youtube.com/embed/CaimKeDcudo</a>
    </div>
    ...
    <div class="item" onclick="location.href='./movies/dynamic.html'; alldata(this)">
      ...
      is
      driven to prove her wrong. With that goal in mind, Buster inspires his players to gamble everything to sneak
      into a talent audition in Redshore City for the demanding entertainment mogul Jimmy Crystal. Against the odds,
      they catch his interest with some frantic creative improvisation and even more desperate lies like personally
      knowing the reclusive rock star, Clay Calloway, who has not been seen in 15 years. Now faced with a tight
      production window with only a vague story idea and dire consequences for failure, Buster and his friends must
      all stretch their talents put on a show against all odds. In that struggle, the gang's challenges seem
      insurmountable, but each of them finds new inspirations and friends where they least expect them to pursue an
      artistic dream worthy of them.</a>
      <a class="invisible trailer">https://www.youtube.com/embed/EPZu5MA2uqI</a>
    </div>
    ...
    <div class="item" onclick="location.href='./movies/dynamic.html'; alldata(this)" >
      ...
      that they must maintain a safe distance between them. As their connection intensifies, so does the temptation
      to throw the rules out the window and embrace that attraction. Love has no boundaries.</a>
      <a class="invisible trailer">https://www.youtube.com/embed/24YrEAGF32M</a>
    </div>
    ...
    <div class="item" onclick="location.href='./movies/dynamic.html'; alldata(this)">
      ...
      journey to heal in a world that feels forever changed.</a>
      <a class="invisible trailer">https://www.youtube.com/embed/Gtl-6RCOl84</a>
    </div>
